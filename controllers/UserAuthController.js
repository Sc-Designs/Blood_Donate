...
module.exports.RegisterUser = async function (req, res, next) {
  try {
      let {
        ...
        if (existingUser) return res.status(406).send("You already have an account, please Login!");
        else {
...
module.exports.LoginUser = async(req,res)=>{
  ...
  if(!user) return res.status(406).send("Oops your email or password was incorrect!")
